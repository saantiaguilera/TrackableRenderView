...
public class ClassPool {
     ...
     */
    private Hashtable<String, Object[]> cflow = null;     // should be synchronous.
     ...
     * @see com.santiago.javassist.ClassPool#getDefault()
     */
    ...
    public static synchronized ClassPool getDefault(Context context) {
        if (defaultPool == null) {
            defaultPool = new ClassPool(null);
            defaultPool.appendSystemPath(context);
        }
    ...
    void recordCflow(String name, String cname, String fname) {
        if (cflow == null)
            cflow = new Hashtable<String, Object[]>();
     ...
     * @see #get(String)
     * @see com.santiago.javassist.bytecode.ConstPool#getClassInfo(int)
     * @see com.santiago.javassist.bytecode.Descriptor#toCtClass(String, ClassPool)
     * @since 3.8.1
     */
     ...
     * @see com.santiago.javassist.ByteArrayClassPath
     */
    ...
    public ClassPath appendSystemPath(Context context) {
        return source.appendSystemPath(context);
    }
     ...
     * @see com.santiago.javassist.ClassPath
     * @see com.santiago.javassist.URLClassPath
     * @see com.santiago.javassist.ByteArrayClassPath
     */
    ...
    public List<FieldInfo> getClassFields(String classname, ConstPool cp) {
    	return source.getClassFields(classname, cp);
    }
    
    public List<MethodInfo> getClassMethods(String classname, ConstPool cp) {
    	return source.getClassMethods(classname, cp);
    }
}
