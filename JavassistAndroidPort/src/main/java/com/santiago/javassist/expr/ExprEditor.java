 ...
 *
 * @see com.santiago.javassist.CtClass#instrument(ExprEditor)
 * @see com.santiago.javassist.CtMethod#instrument(ExprEditor)
 * @see com.santiago.javassist.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
 * @see com.santiago.javassist.CodeConverter
 */
