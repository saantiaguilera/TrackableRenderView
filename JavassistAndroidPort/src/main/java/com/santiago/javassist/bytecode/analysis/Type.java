...
public class Type {
   ...
   Type getRootComponent(Type type) {
    ...
    private Map<String, CtClass> findExclusiveDeclaredInterfaces(Type type, CtClass exclude) {
        ...
        Iterator<String> i = excludeMap.keySet().iterator();
        while (i.hasNext()) {
            Object intf = i.next();
            typeMap.remove(intf);
            thisMap.remove(intf);
    ...
    Map<String, CtClass> findCommonInterfaces(Map<String, CtClass> typeMap, Map<String, CtClass> alterMap) {
        Iterator<String> i = alterMap.keySet().iterator();
        while (i.hasNext()) {
        ...
        Iterator<CtClass> it = new ArrayList<CtClass>(alterMap.values()).iterator();
        while (i.hasNext()) {
            CtClass intf = it.next();
            CtClass[] interfaces;
            try {
