...
package com.santiago.javassist.bytecode.annotation;
 ...
 *
 * @see com.santiago.javassist.bytecode.AnnotationsAttribute#getAnnotations()
 * @see com.santiago.javassist.bytecode.ParameterAnnotationsAttribute#getAnnotations()
 * @see MemberValue
...
public class Annotation {
    ...
    ConstPool pool;
    int typeIndex;
    LinkedHashMap<String, Pair> members;    // this sould be LinkedHashMap
    ...
    public String toString() {
        ...
        if (members != null) {
            buf.append("(");
            Iterator<String> mit = members.keySet().iterator();
            while (mit.hasNext()) {
     ...
     * the default value.
     *
     * @see com.santiago.javassist.bytecode.AnnotationDefaultAttribute
     */
    ...
    public void write(AnnotationsWriter writer) throws IOException {
        ...
        Iterator<Pair> it = members.values().iterator();
        while (it.hasNext()) {
