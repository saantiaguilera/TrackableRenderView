...
package com.santiago.javassist.runtime;
 ...
 *
 * @see com.santiago.javassist.CtBehavior#useCflow(String)
 */
public class Cflow {
	private final ThreadLocal<Depth> local = new ThreadLocal<Depth>() {
