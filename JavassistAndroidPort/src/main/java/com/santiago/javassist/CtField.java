...
import com.santiago.javassist.compiler.SymbolTable;
import com.santiago.javassist.compiler.CompileError;
import com.santiago.javassist.compiler.ast.ASTree;
import com.santiago.javassist.compiler.ast.IntConst;
import com.santiago.javassist.compiler.ast.DoubleConst;
import com.santiago.javassist.compiler.ast.StringL;
...
public class CtField extends CtMember {
        ...
        throws CannotCompileException
    {
        this(src.fieldInfo.getDescriptor(), src.fieldInfo.getName(),
             declaring);
        java.util.ListIterator<AttributeInfo> iterator
     ...
     * </pre></ul>
     *
     * @see com.santiago.javassist.bytecode.Descriptor
     * @see com.santiago.javassist.bytecode.SignatureAttribute
     */
    ...
    public static abstract class Initializer {
         ...
         * @param objectType    the class instantiated for the initial value.
         *
         * @see com.santiago.javassist.CtField.Initializer#byNewArray(CtClass,int)
         * @see com.santiago.javassist.CtField.Initializer#byNewArray(CtClass,int[])
         */
