...
package com.santiago.javassist;
...
import com.santiago.javassist.bytecode.AccessFlag;
import com.santiago.javassist.bytecode.AttributeInfo;
import com.santiago.javassist.bytecode.AnnotationsAttribute;
import com.santiago.javassist.bytecode.BadBytecode;
import com.santiago.javassist.bytecode.Bytecode;
import com.santiago.javassist.bytecode.ClassFile;
import com.santiago.javassist.bytecode.CodeAttribute;
import com.santiago.javassist.bytecode.ConstantAttribute;
import com.santiago.javassist.bytecode.CodeIterator;
import com.santiago.javassist.bytecode.ConstPool;
import com.santiago.javassist.bytecode.Descriptor;
import com.santiago.javassist.bytecode.EnclosingMethodAttribute;
import com.santiago.javassist.bytecode.FieldInfo;
import com.santiago.javassist.bytecode.InnerClassesAttribute;
import com.santiago.javassist.bytecode.MethodInfo;
import com.santiago.javassist.bytecode.ParameterAnnotationsAttribute;
import com.santiago.javassist.bytecode.annotation.Annotation;
import com.santiago.javassist.compiler.AccessorMaker;
import com.santiago.javassist.compiler.CompileError;
import com.santiago.javassist.compiler.Javac;
import com.santiago.javassist.expr.ExprEditor;
...
class CtClassType extends CtClass {
    ...
    private WeakReference<CtMember.Cache> memberCache;
    private AccessorMaker accessors;

    private FieldInitLink fieldInitializers;
    private Hashtable<CtMethod, String> hiddenMethods;    // must be synchronous
    ...
    *
    * @see com.santiago.javassist.CtClass#incGetCounter()
   ...
   /**
    ...
    /**
     * @see com.santiago.javassist.CtClass#prune()
     * @see com.santiago.javassist.CtClass#stopPruning(boolean)
     */
    public void prune() {
        if (wasPruned)
            return;
    ...
    Hashtable<CtMethod, String> getHiddenMethods() {
    ...
    private void makeMemberList(HashMap<String, CtClassType> table) {
        ...
        List<MethodInfo> m = getClassFile2().getMethods();
        int n = m.size();
        for (int i = 0; i < n; i++) {
            MethodInfo minfo = m.get(i);
            table.put(minfo.getName(), this);
        }

        List<FieldInfo> f = getClassFile2().getFields();
        n = f.size();
        for (int i = 0; i < n; i++) {
            FieldInfo finfo = f.get(i);
